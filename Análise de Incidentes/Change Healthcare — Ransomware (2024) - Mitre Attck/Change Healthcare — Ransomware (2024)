...
1. O que essa atividade me ensinou, de forma geral
...
2. O que aprendi sobre o Modelo CIA
...
3. O que aprendi sobre a Cadeia de Ataque
...
4. O que aprendi sobre o MITRE ATT&CK;
...
5. Como os três conceitos se conectam
